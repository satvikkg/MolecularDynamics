...
# Creating files to run desmond molecular dynamics:
    ...
    '''
    f'time = {simulation_duration*1000}'
    '''
...
# Creating the desmond_queu_batch.sh file:
    ...
    f.write(f'"{schrodinger_path}/utilities/multisim" -JOBNAME desmond_setup_{mae_name} -m {desmond_setup_msj_file} {mae_file} -o desmond_setup_{mae_name}-out.cms -HOST localhost -maxjob 1 -TMPLAUNCHDIR -WAIT\n')
    ...
    #f.write(f'''"{schrodinger_path}/utilities/multisim" -VIEWNAME desmond_molecular_dynamics_gui.MDApp -JOBNAME desmond_md_job_{mae_name} -HOST localhost -maxjob 1 -cpu 1 -m desmond.msj -c desmond.cfg -description 'Molecular Dynamics' desmond_setup_{mae_name}-out.cms -mode umbrella -o desmond_md_job_{mae_name}-md-out.cms -lic DESMOND_GPGPU:16 -WAIT\n''')
    f.write(f'echo "MD simulation complete: {mae_name}"\n')
    f.write('\n')
    f.close()

    #-VIEWNAME desmond_molecular_dynamics_gui.MDApp -JOBNAME desmond_md_job_D495 -HOST localhost -maxjob 1 -cpu 1 -m desmond_md_job_D495.msj -c desmond_md_job_D495.cfg -description "Molecular Dynamics" desmond_md_job_D495.cms -mode umbrella -PROJ /home/administrator/.schrodinger/tmp/Tmp_05Apr2024_1100_25920 -DISP append -o desmond_md_job_D495-out.cms -lic DESMOND_GPGPU:16
